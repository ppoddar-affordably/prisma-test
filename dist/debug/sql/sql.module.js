...
const sql_controller_1 = require("./sql.controller");
...
SqlModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [sql_controller_1.SqlController],
        providers: [sql_service_1.SqlService],
        exports: [sql_service_1.SqlService],
    })
], SqlModule);
